...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgCapacity.Text = db.Location.Average(x => x.Capacity).GetValueOrDefault().ToString("0.00"); // Nullable türü dönüştürür ve 2 ondalık basamak gösterir.

            lblAvgLocationPrice.Text = db.Location.Average(x => x.Price).GetValueOrDefault().ToString("0.00") + " TL"; // Nullable türü dönüştürür ve TL ekler.
            ...
            lblTurkiyeCapacittyAvg.Text = db.Location.Where(x => x.Country == "Türkiye").Average(y => y.Capacity).ToString();
